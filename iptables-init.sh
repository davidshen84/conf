...
iptables -A INPUT -p udp -s 192.168.86.0/24 --sport 9999 --dport 9999 -j ACCEPT -m comment --comment 'Google Home'
iptables -A INPUT -p udp -s 192.168.86.0/24 --sport 5353 --dport 5353 -j ACCEPT
